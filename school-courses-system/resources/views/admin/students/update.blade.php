                ...
                <form action="{{route('student.edit',compact('student'))}}" method="post" class="w-full h-full flex flex-row-reverse">
                    ...
                    <div class="w-1/2 h-full flex flex-col items-end pr-20 relative">
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <select name="birth_year" id="birth_year" class="w-2/5 h-8 border border-gray-400 rounded outline-0 pl-3">
                                @for($i=2006;$i>=1980;$i--)
                                    <option value={{$i}} {{$student->birth_year==$i?'selected':''}}>{{$i}}</option>
                                @endfor
                            </select>
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="text" name="address" id="address" value="{{$student->address}}" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                    ...
                    <div class="w-1/2 h-full flex flex-col items-end pr-20">
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="text" name="father_name" id="father_name" value="{{$student->father_name}}" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="text" name="father_job" id="father_job" value="{{$student->father_job}}" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="text" name="father_phone" id="father_phone" value="{{$student->father_phone}}" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
