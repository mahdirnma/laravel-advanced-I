                ...
                <form action="{{route('product.store')}}" method="post" class="w-full h-full flex flex-row-reverse">
                    ...
                    <div class="w-1/2 h-full flex flex-col items-end pr-20 relative">
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <textarea name="description" id="description" cols="25" rows="3" class="rounded outline-0 p-2 border border-gray-400"></textarea>
                        ...
                        <div class="w-5/6 h-auto flex flex-row-reverse justify-between pt-4 mb-6">
                            ...
                            <input type="number" name="price" id="price" step="1000" class="w-2/5 h-8 rounded outline-0 p-2 border border-gray-400">
                            @if($errors->has('price'))
